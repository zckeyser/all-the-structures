...
### Bubble Sort
![Bubble Sort Visualization](./img/sorts/bubble-sort.svg =400x)
...
### Insertion Sort
![Insertion Sort Visualization](./img/sorts/insertion-sort.png =400x)
...
### Chaining
![An example of chaining using a linked list implementation](./img/hash-table/hash-table-chaining.svg =400x)
...
### Open Addressing
![An example of open addressing using linear probing](./img/hash-table/hash-table-open-addressing.svg =400x)
